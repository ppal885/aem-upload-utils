...
const options = new FileSystemUploadOptions()
    .withUrl('https://author-p111055-e1081044.adobeaemcloud.com/content/dam/ibm')
    .withDeepUpload(true)
...
async function run() {
    ...
    await fileUpload.upload(options, [
        '/Users/pulgupta/Library/CloudStorage/OneDrive-Adobe/Dox-Content/6k_files/6k_topics/gasb-qa_utf8'
    ]);
}
run();